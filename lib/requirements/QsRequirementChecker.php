<?php
/**
 * QsRequirementChecker class file.
 *
...
/**
 * QsRequirementChecker allows checking if current system meets the requirements for running application.
 * This class allows rendering check report for the web and console application interface.
 *
 * Example:
 * <code>
 * require_once('path/to/QsRequirementChecker.php');
 * $requirementsChecker = QsRequirementChecker();
 * $requirements = array(
 *     array(
 ...
 *     ),
 * );
 * $requirementsChecker->checkDefault()->check($requirements)->render();
 * <code>
 *
 ...
 * </code>
 *
 * Note: this class definition does not match ordinary code style, because it should match PHP 4.3
...
class QsRequirementChecker {
	 ...
	 * @return QsRequirementChecker self instance.
	 */
	...
	/**
	 * Performs the check for the default requirements.
	 * @return QsRequirementChecker self instance.
	 */
	function checkDefault() {
		return $this->check($this->getDefaultRequirements());
	}

	/**
	 * Returns default requirements.
	 * @return array|string default requirements.
	 */
	function getDefaultRequirements() {
		return dirname(__FILE__) . DIRECTORY_SEPARATOR . 'requirements.php';
	}
