...
/**
 * QsOAuthToken represents OAuth token.
 *
 * @property array $params public alias of {@link _params}.
 ...
 */
class QsOAuthToken extends CComponent {
	/**
	 ...
	 */
	public $_expireDurationParamKey;
	/**
	 ...
	 * @return QsOAuthToken self instance.
	 */
	...
	public function setToken($token) {
		return $this->setParam($this->tokenParamKey, $token);
	}
	...
	public function setTokenSecret($tokenSecret) {
		return $this->setParam($this->tokenSecretParamKey, $tokenSecret);
	}
